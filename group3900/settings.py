"""
Django settings for group3900 project.
...
ALLOWED_HOSTS = ['pythonanywhere.com', 'localhost', '127.0.0.1', '34.227.15.47']
...
WSGI_APPLICATION = 'group3900.wsgi.application'
