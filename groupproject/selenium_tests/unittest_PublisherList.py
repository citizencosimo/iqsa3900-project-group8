...
class unittest_TestLogin(unittest.TestCase):
  ...
  def test_ll(self):
    ...
    time.sleep(1)
    self.driver.find_element(By.LINK_TEXT, "Publisher List").click()
    time.sleep(1)
    self.driver.find_element(By.LINK_TEXT, "Add Publisher").click()
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_name").click()
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_name").send_keys("123")
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_country").send_keys("123")
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_description").send_keys("123")
    time.sleep(1)
    ...
    self.driver.find_element(By.ID, "id_publisher_name").click()
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_name").send_keys("ABC")
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_country").send_keys("ABC")
    time.sleep(1)
    self.driver.find_element(By.ID, "id_publisher_description").send_keys("ABC")
    time.sleep(1)
    self.driver.find_element(By.CSS_SELECTOR, ".btn:nth-child(7)").click()
    time.sleep(1)
    self.driver.find_element(By.LINK_TEXT, "123ABC").click()
    time.sleep(1)
    self.driver.find_element(By.LINK_TEXT, "Database Tools").click()
    time.sleep(1)
    self.driver.find_element(By.LINK_TEXT, "Publisher List").click()
