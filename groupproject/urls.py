...
urlpatterns = [
    ...
    path('delete_publisher/<int:pk>', views.DeletePublisher, name='delete_developer'),
    ...
    path('developers', views.DeveloperList, name="develop_list"),
    ...
    path('view_platform/<int:pk>', views.ViewPlatform, name='platform_list'),
